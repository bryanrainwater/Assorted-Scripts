...
asm_main:
	...
	LDI    R29, 0
	LDI    R20.w0, 0x0FFF                ; For masking unused bits
	LDI    R20.w2, 0x0FFF

sampleAD9201:
	; Changed code for AD9201 sampling
	WBS    R31, 16                       ; Wait for falling edge
	WBC    R31, 16                       ; Wait for rising edge
