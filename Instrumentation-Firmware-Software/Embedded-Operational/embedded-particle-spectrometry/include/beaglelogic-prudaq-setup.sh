...
echo 'Setting up BeagleLogic for continuous capture, 1 for cont, 0 for oneshot'
echo 1 > /sys/devices/virtual/misc/beaglelogic/triggerflags

#echo 'Setting up sample size'
#echo 4194304 > /sys/devices/virtual/misc/beaglelogic/memalloc
#echo 8388608 > /sys/devices/virtual/misc/beaglelogic/memalloc
#echo 12582912 > /sys/devices/virtual/misc/beaglelogic/memalloc
#echo 16777216 > /sys/devices/virtual/misc/beaglelogic/memalloc
#echo 33554432 > /sys/devices/virtual/misc/beaglelogic/memalloc
echo 67108864 > /sys/devices/virtual/misc/beaglelogic/memalloc


#echo 'Setting sample unit to 16 bit, value of 0'
#echo 1 > /sys/devices/virtual/misc/beaglelogic/sampleunit
...
echo 100 > /sys/devices/ocp.3/pwm_test_P9_31.13/duty
# 2000ns period = 500kHz frequency
# 200ns period = 5MHz frequency
# 400ns period = 2.5MHz frequeny
# Using value of 100, with freq generator at 312KHz (16 pts in a 5MHz signal), only captures half a sinusoid
# With value at 50, seems to capture at 16.64 MHz....., probably trying to do 20MHz here and can't,
# I have confirmed 200 gives 2.5MHz per channel....
# 100 gives ~9MHz/channel I believe
echo 200 > /sys/devices/ocp.3/pwm_test_P9_31.13/period
