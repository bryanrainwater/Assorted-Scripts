...
class DSMLoop(QThread):
   ...
   def run(self):
      ...
      while not self.stopFlag:
         ...
         #print(dsm.analogIntStatus());
         #print(dsm.DMMuserfun())
     
         #testval = dsm.analogIntStatus() 
         #if(testval == 1):
         #   continue
         ...
         try:
            ...
            if np.allclose(SCcopy,SC):#(oldSC == SC).all():
               lossCtr += 1
