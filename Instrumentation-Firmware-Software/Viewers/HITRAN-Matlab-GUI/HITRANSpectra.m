...
% Notice the Half Width at Half Maxium for the vD and vL inputs;
    ...
    hax = axes('Units','pixels','Position',[60,160,500,400]);
    
    %construct the components
    %Wavelengh Options
    wvlgthoptions = uipanel('Units','pixels','ShadowColor',...
        [0.1,1,0.1],'Position',[60 20 500 100]);
    
    domainoption=uicontrol('Style','text','String',...
        'Wavelength or Wavenumber','Position',...
        [60 80 200 80]);
    
    wvglthvwavenum = uicontrol('Style','popupmenu',...
        'String',{'Wavelength','Wavenumber'},...
        'Foregroundcolor',[0.99 0.01 0.01],'FontWeight','bold',...
        'Value',1,'Position',[70 30 200 80],'Callback',{@popup_Callback});
    
    hp = uipanel('Units','pixels','ShadowColor',[0.1,1,0.01],...
              'Position',[628 160 200 430]);
        
    
    hpb1 = uicontrol('Style','pushbutton','String','Open HITRAN File',...
